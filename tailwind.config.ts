    ...
    extend: {
      colors: {
        ...
        kona: {
          ...
          "orange-deep": "hsl(var(--kona-orange-deep))",
          chartreuse: "hsl(var(--kona-chartreuse))",
          "chartreuse-deep": "hsl(var(--kona-chartreuse-deep))",
          ...
          "pomegranate-deep": "hsl(var(--kona-pomegranate-deep))",
          white: "hsl(var(--kona-white))",
        },
        charcoal: "hsl(var(--charcoal))",
        "section-pink": "hsl(var(--pink-soft))",
        "section-grey": "hsl(var(--grey-soft))",
        sidebar: {
